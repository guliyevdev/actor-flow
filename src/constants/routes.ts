...
const ROOTS_PRICING = '/admin/pricing';
const ROOTS_ORDERS = '/admin/orders';
...
export const PATH_PRICING = {
  root: ROOTS_PRICING,
  main: path(ROOTS_PRICING, '/main'),
  roads: path(ROOTS_PRICING, '/roads'),
  category: path(ROOTS_PRICING, '/category'),
};

export const PATH_ORDERS = {
  root: ROOTS_ORDERS,
  main: path(ROOTS_ORDERS, '/main')
};
